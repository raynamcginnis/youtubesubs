...
class Youtube_Subs_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo $args['before_widget']; // anything you want to display before widget like <div> etc. 
        ...
        echo $args['after_widget']; // anything you want to display after the widget like </div> etc. 
	}
	...
	public function form( $instance ) {
        ...
        $channel = ! empty( $instance['channel'] ) ? $instance['channel'] : esc_html__( 'raynamcginnis', 'yts_domain' );
        ...
        <?php esc_attr_e( 'Layout:', 'yts_domain' ); ?></label> 
		<select
            class="widefat"
        ...
        <?php esc_attr_e( 'Count:', 'yts_domain' ); ?></label> 
		<select
            class="widefat"
